...
--Put results into another table
...
DROP TABLE retirement_info;
-- Add employe ID to retirement table
...
-- Put retirement stuff into a table
SELECT ri.emp_no,
    ri.first_name,
    ri.last_name,
	de.to_date
...
-- Employee count by department number put into table
SELECT COUNT(ce.emp_no), de.dept_no
